...
void main() {
  testWidgets(
    'App boots with Provider and shows expected UI elements',
    (tester) async {
      // Build the app
      ...
      // title text appears in appbar and possibly MaterialApp title
      ...
      expect(
        placeholderCount >= 16,
        isTrue,
        reason: 'Expected at least 16 grid placeholders',
      );
