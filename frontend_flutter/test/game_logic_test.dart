...
void main() {
  group('GameLogic basic invariants', () {
    ...
    test(
      'move returns no change for impossible direction on empty-like board',
      () {
        final rng = Random(1);
    ...
    test('merge increases score and produces a merge step', () {
      ...
      final board = Board.empty()
          .placeTile(const Tile(id: 1, value: 2, row: 0, col: 0))
          .placeTile(const Tile(id: 2, value: 2, row: 0, col: 1));
